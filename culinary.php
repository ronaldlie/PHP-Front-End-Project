...
<?php while ($row = mysqli_fetch_array($foto))
        {?>
<div class="card mb-3">
  <img class="card-img-top" src="../backend/images/<?php echo $row["foodfoto"]?>" alt="Card image cap" style="width:500px">
  <div class="card-body">
    <h5 class="card-title"><?php echo $row["foodnama"]?></h5>
    <p class="card-text"><?php echo $row["foodketerangan"]?></p>
